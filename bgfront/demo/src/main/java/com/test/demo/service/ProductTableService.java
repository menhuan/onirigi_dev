...
//	String colunSql="select * from information_schema.COLUMNS where table_name='cz_lottery_data_today'";
		...
		private  static final Logger LOGGER =LoggerFactory.getLogger(ProductTableService.class);
		 ...
		 * 字段类型
		 */
		private static final String BEANTYPE="  public  " ;
